const themeToggle = document.querySelector(".theme-toggle");
    ...
    const applyFilter = async (imgUrl, imgIndex) => {
      ...
      if (!imgCard) {
        console.error(`Image card with ID img-card-${imgIndex} not found`);
        return;
      }

      try {
        // Rasmni mahalliy yuklash uchun Blob sifatida olish
    ...
    const updateImageCard = (imgIndex, imgUrl) => {
      ...
      imgCard.innerHTML = `
        ...
        <div class="img-overlay">
         ...
         <button 
  class="img-edit-btn" 
  onclick="applyFilter('${imgUrl}', ${imgIndex})"
  style="
...
>
  <i class="fa-solid fa-edit" style="pointer-events: none;"></i>
</button>
